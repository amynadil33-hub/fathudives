...
import { Anchor, ShieldCheck, HeartHandshake, Wrench, Ship, Leaf, MapPin, Navigation } from 'lucide-react'
      ...
      <Section tone="seafoam">
        <Container>
          <div className="grid items-center gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-14">
            <Reveal>
              <EditorialLabel>Find us</EditorialLabel>
              <h2 className="mt-4 font-serif text-4xl leading-tight text-foreground sm:text-5xl">
                Visit us in Dhangethi
              </h2>
              <p className="mt-5 leading-relaxed text-muted-foreground">
                Fathu Dives is on Dhangethi Island in South Ari Atoll, close to the harbour and the
                island&apos;s guesthouses. Open the location in Google Maps or get directions from
