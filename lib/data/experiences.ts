...
export const adventureOptions: AdventureOption[] = [
  ...
  },
  {
    ...
    recommendationSlug: 'adventurer-dive-package',
    recommendationLabel: 'Adventurer Dive Package',
  },
  {
    id: 'adv-reefs',
    ...
    recommendationType: 'package',
    recommendationSlug: 'extreme-dive-package',
    recommendationLabel: 'Extreme Dive Package',
  },
  {
    id: 'adv-friends',
    ...
    recommendationType: 'package',
    recommendationSlug: 'explorer-dive-package',
    recommendationLabel: 'Explorer Dive Package',
  },
  {
    id: 'adv-relax',
    ...
    recommendationType: 'package',
    recommendationSlug: 'basic-dive-package',
    recommendationLabel: 'Basic Dive Package',
  },
  {
    id: 'adv-photography',
